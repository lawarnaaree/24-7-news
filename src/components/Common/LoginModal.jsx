/* ============================================
   LoginModal — Mock login/signup UI
   ============================================ */
      ...
      <div className="modal-card" onClick={(e) => e.stopPropagation()}>
        ...
        <div className="modal-content">
          <div className="modal-logo">
            <span className="modal-logo__text">24/7 news</span>
          </div>
          <h2 className="modal-title">Join the community</h2>
          <p className="modal-subtitle">Stay informed, follow topics, and contribute to the news.</p>

          <div className="modal-options">
            <button className="modal-btn modal-btn--github">
            ...
            <button className="modal-btn modal-btn--google">
              <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor">
